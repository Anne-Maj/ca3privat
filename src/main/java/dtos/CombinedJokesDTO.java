...
public class CombinedJokesDTO {
    ...
    private String insultReference;

    public CombinedJokesDTO(DadDTO dadDTO, ChuckDTO chuckDTO, InsultDTO insultDTO) {
        ...
        this.insultReference=insultDTO.getUrl();
        
    }
    public CombinedJokesDTO (String joke1, String joke1Reference, String joke2, String joke2Reference, String insult, String insultReference){
        this.joke1 = joke1;
        this.joke1Reference = joke1Reference;
        this.joke2=joke2;
        this.joke2Reference=joke2Reference;
        this.insult=insult;
        this.insultReference=insultReference;
    ...
    public String getInsultReference() {
        return insultReference;
    }

    public void setInsultReference(String insultReference) {
        this.insultReference = insultReference;
    }
